...
<center>
    ...
    <div style ="padding:5px; margin-top:50px;">
         <img src="ayasofya.jpg" width="600" height="400" alt=""/>
    </div> 
</center>
    <div style ="padding:5px; margin-left:240px; margin-top:50px; margin-right:240px;">
        <p>
        Ayasofya, İstanbul'da tarihî bir müze. Bizans İmparatoru I. Justinianus tarafından, 532-537 yılları arasında İstanbul'un tarihî yarımadasındaki eski şehir merkezine inşa ettirilmiş bazilika planlı bir patrik katedrali olup 1453 yılında İstanbul'un Osmanlılar tarafından alınmasından sonra Fatih Sultan Mehmet tarafından camiye dönüştürülmüştür. 1935 yılından beriyse müze olarak hizmet vermektedir.Ayasofya, mimar bakımdan bazilika planı ile merkezî planı birleştiren kubbeli bazilika tipinde bir yapı olup kubbe geçişi ve taşıyıcı sistem özellikleriyle mimarlık tarihinde önemli bir dönüm noktası olarak ele alınır.
        </p>
    </div>
    ...
    <div style ="padding:5px; margin-top:50px;">
         <img src="yerebatansarnıcı.jpg" width="600" height="400" alt=""/>
    </div> 
</center>
    <div style ="padding:5px; margin-left:240px; margin-top:50px; margin-right:240px;">
        <p>
    ...
    <center>
    <h1> Topkapı Sarayı </h1>

    <div style ="padding:5px; margin-top:50px;">
     <img src="topkapisarayi.jfif" width="600" height="400" alt=""/>
    </div> 
    </center>
<div style ="padding:5px; margin-left:240px; margin-top:50px; margin-right:240px;">
    <p>
